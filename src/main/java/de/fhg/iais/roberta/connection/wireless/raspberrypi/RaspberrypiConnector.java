 ...
 */
public class RaspberrypiConnector extends AbstractConnector<Raspberrypi> {
    private static final Logger LOG = LoggerFactory.getLogger(RaspberrypiConnector.class);

    private final RaspberrypiCommunicator raspberrypiCommunicator;


    /**
     * Constructor for tha NAO connector.
     *
     * @param rasp the NAO that should be connected to
     */
    RaspberrypiConnector(Raspberrypi rasp) {
        super(rasp);
        this.raspberrypiCommunicator = new RaspberrypiCommunicator(rasp);
    }
    ...
    private void connectButtonIsPressed() {
        ...
        JSONObject deviceInfo = this.raspberrypiCommunicator.getDeviceInfo();
    ...
    private void waitForCmd() {
        JSONObject deviceInfoWaitCMD = this.raspberrypiCommunicator.getDeviceInfo();
    ...
    private void waitUpload() {
        try {
            ...
            this.raspberrypiCommunicator.uploadFile(program.getFirst(), program.getSecond());
